...
int main(int argc, char *argv[])
{
    ...
    QCoreApplication::setOrganizationName("MMMMusicPlayer");
    QCoreApplication::setOrganizationDomain("MMMMusicPlayer.com");
    QCoreApplication::setApplicationName("MMMMusicPlayer");
