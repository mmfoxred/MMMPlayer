...
void MusicPreviewLabel::paintEvent(QPaintEvent *)
{
    ...
    painter.drawText(rect(), Qt::AlignLeft | Qt::AlignVCenter, "This is MMMMusicPlayer");

    painter.setPen(QColor(0, 0, 0, 200));
    painter.drawText(rect(), Qt::AlignLeft | Qt::AlignVCenter, "This is MMMMusicPlayer");

    painter.setPen(QPen(m_linearGradient, 0));
    painter.drawText(1, 1, rect().width(), rect().height(), Qt::AlignLeft | Qt::AlignVCenter, "This is MMMMusicPlayer");

    painter.setPen(QPen(m_maskLinearGradient, 0));
    painter.drawText(1, 1, 60, rect().height(), Qt::AlignLeft | Qt::AlignVCenter, "This is MMMMusicPlayer");
    painter.end();
}
